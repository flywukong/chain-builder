...
function buildPrompt(data) {
  return [
    ...
    "   - **4) 全网版本**:看 versionUpgrade。落后的定义是『版本低于主流 mainstream(出块节点最多的众数)』,不是低于最新版 latest。先一句写主流版本 mainstream(可附最新版 latest 作参考);若 laggardCount>0,每个落后节点一行「- 节点名(自营/外部)· 当前版本」(level=major 的大版本落后优先点名、建议尽快升级);无落后则一句「全网版本基本一致,主流 vX.Y.Z」。",
    "",
