...
function buildPrompt(data) {
  return [
    ...
    "",
    "要求：",
    "1. 第一行输出 24h 基本面播报,固定以 [播报] 开头、一行写完:用 2~3 个完整短句概括 出块节奏 / MEV 与 builder 格局 / 流量水位 / 安全面(slash·reorg),口吻平实像值班同事口播,不用 markdown,90 字以内。无论正常与否这一行都必须有。",
